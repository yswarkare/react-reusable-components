...
export const setInitial = (object) => {
...
export const setNewObjectPropsModel = (object) => {
	for (const key in object) {
		if (this.hasOwnProperty(key)) {
...
export const updateKeyValue = (object) => {
...
export const validateProp = (prop_01) => {
...
export const validateProp_01 = (key) => {
